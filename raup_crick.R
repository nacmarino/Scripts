# this a function provided by Chase et al, 2011, Ecosphere, Using null models to disentangle variation in community dissimilarity from variation in alpha-diversity 
# this function calculates the raup-crick dissimilarity index between pairs of sites, controling for differences in species richness between them
